...
DEFAULTS: dict[str, Any] = {
    ...
    "scoring": {"alpha": 0.0, "primary_metric": "head_full_vocab_kl_fixed_prefix",
                ...
                "arithmetic_mode": "isolated_row_bf16_reference_v1", "reduction_dtype": "float32",
                "aggregation": "equal_task_episode_step_dimension", "include_inactive_as_zero": True,
                "feature_universe": "all_dictionary_features", "pair_batch_size": 1,
...
def validate_config(updates: dict) -> dict:
    ...
    fixed = {
        ...
        "scoring.edit_backend": "reference",
        "scoring.arithmetic_mode": "isolated_row_bf16_reference_v1",
        "scoring.pair_batch_size": 1,
